...
variable "enable_split_tunnel" {
  description = "Whether split-tunnel is enabled on VPN endpoint"
  type        = bool
  default     = true
}
...
variable "cloudwatch_log_group_retention_in_days" {
  description = "Number of days you want to retain log events in the specified log group for VPN connection logs."
  type        = number
  default     = 30
}
